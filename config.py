...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE_URI","mongodb+srv://Xtxmovies123:JalsAwUixJcwxx1Y@cluster0.viml1ha.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",)
